...
import static userInterfaces.FinalPage.*;
...
public class registroSteps {
    ...
    @Then("^El verifica su registro con el mensaje de bienvenida$")
    public void elVerificaSuRegistroConElMensajeDeBienvenida() {
        actor.should(
			    seeThat(the(TXT_WELCOME), isPresent()),
                seeThat(the(TXT_WELCOME), containsText("Welcome to the world's largest community of freelance software testers!"))
        );
    }
